...
train_set =CIFAR10(root="./data/cifar",train=True,transform=transformations,download=True)
...
test_set = CIFAR10(root="./data/cifar", train=False, transform=transformations, download=True)
